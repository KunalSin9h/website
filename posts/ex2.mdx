...
```exs title="data.ex" showLineNumbers {3,10}
defmodule Data do
...
```exs title="data.ex" showLineNumbers {3}
defmodule Data do
...
```ex title="geometry.ex" showLineNumbers {5}
...
```exs title="geometry.ex" showLineNumbers {5,7}
defmodule Geometry do
  def square_area(a), do: a * a
end
...
```exs title="person.ex" showLineNumbers {12,13}
defmodule Person do
...
```exs title="pipeline.ex" showLineNumbers
